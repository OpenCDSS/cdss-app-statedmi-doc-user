...
|----------------|--------------------------|----------------- |
|`@enabled False`| StateDMI command processor.|Used to disable a command file.  For example, use this annotation in a test command file when the test is not ready for use in the software release process.|
