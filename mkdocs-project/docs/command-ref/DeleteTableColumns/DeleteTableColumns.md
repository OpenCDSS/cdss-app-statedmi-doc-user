# StateDMI / Command / DeleteTableColumns #
...
See the [automated tests](https://github.com/OpenWaterFoundation/cdss-app-statedmi-main/tree/master/test/regression/commands/DeleteTableColumns).
